...
#define N_Phi 6 // # components (of this type)
#define ND_Phi 2 // # process definitions
#define NP_Phi 2 // # action indexes
#define NS_Phi 3 // # sending actions
#define NR_Phi 6 // # receiving actions
#define NV_Phi 3 // # bound variables (max)
...
//----init A3 -----
void init2() {u[2] = 3; c[2] = 1; o[2] = 1;}

//----init A4 -----
void init3() {u[3] = 4; c[3] = 1; o[3] = 0;}

//----init A4 -----
void init5() {u[4] = 5; c[4] = 1; o[4] = 0;}

//----init A4 -----
void init6() {u[5] = 6; c[5] = 1; o[5] = 0;}
...
void check_liveness() {
  _Bool liveness = (o[0] + o[1] + o[2] + o[3] + o[4] + o[5] >= 3);
