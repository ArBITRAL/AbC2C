...
yystate(35, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 109 ->
    yystate(10, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 101 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
yystate(21, [C|Ics], Line, Tlen, _, _) when C >= 103, C =< 122 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 113 ->
    yystate(10, Ics, Line, Tlen+1, 7, Tlen);
